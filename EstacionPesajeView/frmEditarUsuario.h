...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(378, 545);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(181, 545);
			...
			this->groupBox1->Location = System::Drawing::Point(45, 24);
			...
			this->comboBox1->Location = System::Drawing::Point(188, 388);
			...
			this->textBox8->Location = System::Drawing::Point(188, 442);
			...
			this->textBox4->KeyPress += gcnew System::Windows::Forms::KeyPressEventHandler(this, &frmEditarUsuario::textBox4_KeyPress);
			// 
			// textBox3
			// 
			...
			this->ClientSize = System::Drawing::Size(672, 598);
