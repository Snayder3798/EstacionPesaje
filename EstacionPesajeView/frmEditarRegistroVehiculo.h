...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(313, 396);
			...
			// button3
			// 
			this->button3->Location = System::Drawing::Point(167, 396);
			...
			this->Propietario->Location = System::Drawing::Point(32, 253);
