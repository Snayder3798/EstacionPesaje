...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button4
			// 
			this->button4->Location = System::Drawing::Point(448, 479);
			...
			// button3
			// 
			this->button3->Location = System::Drawing::Point(252, 479);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(72, 479);
			...
			this->dataGridView1->Columns->AddRange(gcnew cli::array< System::Windows::Forms::DataGridViewColumn^  >(4) {
				this->multasAcumuladas,
					this->DNI, this->ApellidoPaterno, this->Nombres
			});
			this->dataGridView1->Location = System::Drawing::Point(32, 255);
			this->dataGridView1->Margin = System::Windows::Forms::Padding(4);
			this->dataGridView1->Name = L"dataGridView1";
			this->dataGridView1->RowHeadersWidth = 51;
			this->dataGridView1->Size = System::Drawing::Size(572, 185);
			...
			this->groupBox1->Location = System::Drawing::Point(69, 24);
			...
			this->ClientSize = System::Drawing::Size(637, 529);
