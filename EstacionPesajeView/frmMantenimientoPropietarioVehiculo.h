...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->radioButton2->CheckedChanged += gcnew System::EventHandler(this, &frmMantenimientoPropietarioVehiculo::radioButton2_CheckedChanged);
			// 
			// radioButton1
			// 
			...
			this->radioButton1->CheckedChanged += gcnew System::EventHandler(this, &frmMantenimientoPropietarioVehiculo::radioButton1_CheckedChanged);
			// 
			// button1
			// 
			...
			this->textBox1->KeyPress += gcnew System::Windows::Forms::KeyPressEventHandler(this, &frmMantenimientoPropietarioVehiculo::textBox1_KeyPress);
			// 
			// frmMantenimientoPropietarioVehiculo
			// 
			...
			this->Text = L"Mantenimiento Propietario Vehículo";
